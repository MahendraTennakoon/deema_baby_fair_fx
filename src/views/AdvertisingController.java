...
public ObservableList<OfferModel> getAllOffers(){
  ...
  adv.setData("INSERT INTO offer(offer_id,name,discount,description,effectivefrom,effectiveto) VALUES ('" + offer_id + "','" + name + "','" + discount + "','" + description+ "','" + date_effectivefrom + "','" + date_effectiveto + "')");
